                                ...
                                <div class="col-sm-12">
                                    <form action="{{ route('education.store') }}" method="post">
                                        ...
                                        <div class="form-group" style="color:#6B778C; margin-top:70px;">
                                            ...
                                            <textarea name="name" value="" placeholder="ex) OO大学, OO学部" cols="68"rows="10" class="border" style="padding: 2.5rem 3.3rem; background-color:#f1f5f9;border-radius: 6px; width: 100%;"></textarea>
                                        </div>
